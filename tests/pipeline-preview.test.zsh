...
test_reset_restores_full_buffer() {
  ...
  _pipeline_preview_original_ctrl_g_binding='some-widget'
  _pipeline_preview_original_refresh_binding='refresh-widget'
...
test_reset_restores_original_bindings() {
  ...
  local -a expected_bindkey_calls=(
    '^G:pipeline-preview-toggle-live-output'
    '^X^G:pipeline-preview-refresh-source-output'
    '^G:some-widget'
    '^X^G:refresh-widget'
  )
...
test_toggle_live_output_caches_left_hand_side() {
  ...
  local -a expected_bindkey_calls=('^X^G:pipeline-preview-refresh-source-output')
...
test_refresh_source_output_reloads_cache() {
  ...
  BUFFER=$'printf \'foo\\nbar\\n\' | grep -c .'
  pipeline-preview-toggle-live-output
  _pipeline_preview_source_command=$'printf \'foo\\n\''
...
test_accept_line_resets_preview_state() {
  ...
  test::assert_eq "accept-line deactivates preview" "0" "$_pipeline_preview_activated"
